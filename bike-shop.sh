...
RENT_MENU() {
    ...
    then
        # send to main menu
        MAIN_MENU "Sorry, we don't have any bikes right now."
    else 
        ...
        then
            ...
            then 
                ...
                # set bike availability for false
                ...
                BIKE_INFO_FORMATTED=$(echo $BIKE_INFO | sed 's/ |/"/i')
